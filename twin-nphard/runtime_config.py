...
flags.DEFINE_string('architecture', 'centralized', 'Model architecture.')  # centralized, decentralized
...
flags.DEFINE_float('dropout_op', 0.0, 'Dropout rate (1 - keep probability) of a graph shift operator.')
flags.DEFINE_float('weight_decay', 5e-4, 'Weight for L2 loss on embedding matrix.')
flags.DEFINE_integer('early_stopping', 1000, 'Tolerance for early stopping (# of epochs).')
flags.DEFINE_integer('max_degree', 1, 'Maximum Chebyshev polynomial degree.')
flags.DEFINE_integer('num_layer', 3, 'number of layers.')
...
flags.DEFINE_string('datapath','./data/ER_Graph_Uniform_mixN_mixp_train0', 'Location of Data')
...
flags.DEFINE_bool('load_pretrained', False, 'load pretrained models')
